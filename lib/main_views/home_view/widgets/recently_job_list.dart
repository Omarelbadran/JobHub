...
import 'package:job_hub_app/main_views/home_view/widgets/recently_job_card.dart';

import '../../../models/job_model/job_model.dart';
class RecentlyJobList extends StatelessWidget {
  final List<JobModel> jobs;
  const RecentlyJobList ({super.key, required this.jobs});
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return  RecentlyJobCard(job : job);
        },
      ),
    );
  }
